          ...
          <table className="w-full border-collapse border border-black text-xs">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-black p-1 text-right font-bold">¥{quote.subtotal.toLocaleString()}</td>
              </tr>
              <tr>
                <td colSpan={7} className="border border-black p-1 text-right font-bold">消費税(10%)</td>
                <td className="border border-black p-1 text-right font-bold">¥{quote.tax_amount.toLocaleString()}</td>
              </tr>
              <tr>
                <td colSpan={7} className="border border-black p-1 text-right font-bold bg-gray-100">合計</td>
                <td className="border border-black p-1 text-right font-bold bg-gray-100">¥{quote.total_amount.toLocaleString()}</td>
              </tr>
            </tbody>
          </table>
        </div>
